...
model_config = load_from_json('../../../task1/attack2/model_config.json')
data_config = load_from_json('../../../task1/attack2/data_config.json')
attack_config = load_from_json('../../../task1/attack2/attack_config.json')
